...
class QuizShowPageTeachersProfile : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding=DataBindingUtil.inflate(inflater,R.layout.fragment_quiz_show_page_teachers_profile, container, false)
        layoutManager= StaggeredGridLayoutManager(2, LinearLayoutManager.VERTICAL)
        binding.RecyclerViewStudentSideQuiz.layoutManager=layoutManager
        adapterGetQuiz= RecyclerAdapterQuizTEachersSide(FragmentTeachersProfileShowPageStudentSide.teacher_profile_quizzes)
